...
from datasets.cifar_db import cifar_DB
...
def parse_args():
    ...
    parser.add_argument(
        "--dataset", default="cifar_train", help="Dataset to train on. Default: mnist_train"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    assert args.dataset in ["cifar_train", "cifar_test"], "Unknown dataset: %s" % args.dataset
    ...
    train_loader = DataLoader( cifar_DB("cifar_train", root_dir=None, transform=trans_train), 
                            batch_size=batch_size,
                            shuffle = True,
                            **kwargs,
    )       
    test_loader = DataLoader( cifar_DB("cifar_test", root_dir=None, transform=trans_test),
                            batch_size=batch_size,
                            shuffle=False,
                            **kwargs,    
    )
